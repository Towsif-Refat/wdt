...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 17, 2022 at 08:28 PM
...
('1001', 'Admin', 'admin@gmail.com', '1234567@'),
...
(19, 1250773429, 'A Prayer for Owen Meany', 3001, '2022-11-16 18:00:00', '2022-11-18', 0, 0);
...
(1, '3004', 'Rahim', '2022-06-01', '2022-07-14', 'Rejected');
...
(1, '7001', 'akash', 'akash@gmail.com', '01776304248', 'male', '1998-07-16', '123'),
...
(1, 'New books now available on our library', 'New books now available on our library. Please bring your student id along to borrow books', '2022-11-18 00:00:00'),
(3, 'Php and mysql with web', 'learn webdevelopment to read Php and mysql  book.Available in our library.', '2022-11-18 00:00:00');
...
(1, 'There is no class tomorrow (07/04/2022)', '2022-04-06 13:34:32');
...
(19, '1250773563', 'A Tree Grows in Brooklyn', 'Betty Smith', '14th edition', 5019, '2022-11-15 14:33:04');
...
(1, 'It is to notify to all concerned that the School will remain closed (including all online classes) on Tuesday, March 30th 2021 due to Shab e-Barat, 2022.  ', '2022-11-17 19:12:04'),
(3, 'It is to notify to all concerned that the School will remain closed (including all online classes) on Sunday, February 21,  2021 due to Language Movement Day 2022.  ', '2022-11-17 19:11:54');
...
('3001', 'Mr A', 'a@gmail.com', '01711811411', 'male', '2006-02-02', 'Seven', 'B', '25', 'Ullapara,Sirajganj', '12345678@', '98'),
...
('4004', 'Laura', 'l@gmail.com', '01772541167', 'female', '2003-09-11', 'Seven', 'B', '65', 'khulna', '12345678@', '87');
...
(25, 4001, 'Saiful', 'saiful@gmail.com', 'male'),
(62, 4002, 'Mr Rahim', 'rahim@gmail.com', 'male');
...
('2001', 'Mr Y', 'y@gmail.com', '01764199181', 'male', '1984-08-09', '', '4567'),
('2002', 'nahin all', 'nahin@gmail.com', '01711845611', 'male', '2009-07-15', '', '1234@1234'),
('2003', 'Ankon', 'a@gmail.com', '01745361245', 'male', '2016-02-09', '', '12341234@'),
('2006', 'Siam', 's@s.com', '01756984231', 'male', '2013-01-02', 'Math', '12345@@123'),
('2008', 'John', 'john@gmail.com', '01758964512', 'male', '2021-04-23', '', '1234567!'),
('2009', 'Mr Rahman', 'rahman@gmail.com', '01725345432', 'Male', '2013-06-23', 'Math', '1234567@'),
('2011', 'Faishal', 'faishal@gmaill.com', '01711814155', 'male', '2019-03-16', '', '12345678@'),
('2013', 'Mr salam', 'salam@gmail.com', '01715431415', 'male', '2014-03-20', '', '12345678@'),
...
(3, 'canvas.png', '2022-11-16 15:45:35'),
(5, 'dhaka-map.jpg', '2022-11-16 18:00:00'),
(6, 'Graph.png', '2022-11-17 19:23:38');
...
--
ALTER TABLE `issuedbookdetails`
  MODIFY `serialno` int(3) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=20;
